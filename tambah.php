				...
				<div class="col-lg-6">
					...
					<div class="card">
						...
						dengan method post ke proses crud dengan paramater get aksi tambah -->
							<form action="proses/crud.php?aksi=tambahBarang" method="POST">
								...
								<div class="form-group">
									...
									<input type="text" value="" class="form-control" name="keterangan_barang" required>
								</div>								
								<div class="form-group">
									<label>Satuan </label>
									<input type="text" value="" class="form-control" name="satuan_barang" required>
								</div>
								<div class="form-group">
